...
REAL statecheck ToolContract/execute_contracted mechanism and reports
how gate decisions line up against ground-truth labels.

SCOPING NOTE: statecheck's gate is a deterministic pre_condition/
...
from statecheck.tool_executor import execute_contracted, ToolContract
